...
abstract class BaseShowListsDataSource {
  ...
  Future<ShowProjectsListDataModel> getPaginationOfShowProjectsListsData(String params);
}
...
class ShowListsDataSource implements BaseShowListsDataSource {
  ...
  Future<ShowMoreDataModel> getShowListsData(String params) async {
    final response = await apiConsumer.get("${EndPoints.baseUrl}home/$params-ads");
  ...
  @override
  Future<ShowProjectsListDataModel> getShowProjectsListsData(String params) async {
    final response = await apiConsumer.get("${EndPoints.baseUrl}home/$params-ads");
    return ShowProjectsListDataModel.fromJson(response);
  }

  @override
  Future<ShowProjectsListDataModel> getPaginationOfShowProjectsListsData(String params) async {
    final response = await apiConsumer.get(params);
    return ShowProjectsListDataModel.fromJson(response);
  }
