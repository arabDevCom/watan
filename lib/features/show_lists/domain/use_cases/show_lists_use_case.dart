...
class GetShowListsUseCase implements UseCase<ShowMoreDataModel, String> {
  final BaseShowListsRepositories baseShowListsRepositories;

  const GetShowListsUseCase({required this.baseShowListsRepositories});

  @override
  Future<Either<Failure, ShowMoreDataModel>> call(String params) =>
      baseShowListsRepositories.getShowListsData(params);
}
